...
export const onCreateLike = functions.firestore.document('Perguntas/{perguntaUid}/Likes/{likeId}')
    .onCreate(async(snapshot, context) => {
        try {
            await admin.firestore().collection('Perguntas').doc(context.params.perguntaUid).update({
...
export const onDeleteLike = functions.firestore.document('Perguntas/{perguntaUid}/Likes/{likeId}')
